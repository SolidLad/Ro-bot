    ...
    public void run(MessageReceivedEvent event, String[] args) {
        String suffix;
            ...
            try {
                ...
                URLConnection temp = new URL("http://api.soundcloud.com/resolve.json?url="+suffix+"&client_id=").openConnection();
                ...
                audioUrl = new URL("http://api.soundcloud.com/tracks/"+urlString.substring(34,43)+"/stream?client_id=");
                HttpURLConnection.setFollowRedirects(false);
                URLConnection con2 = audioUrl.openConnection();
                InputStream in = new URL("http://api.soundcloud.com/tracks/"+urlString.substring(34,43)+"?client_id=").openStream();
                int i;
                char c;
                String data = "";
                try{
